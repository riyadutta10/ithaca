...
saveRDS(opposing_melt, paste0(PATH_SAVE_EVAP_TREND, "land_use_dataset_rank_opposing_DCI.rds")) 
...
opposing_melt <- opposing_melt[opposing_0_01 == 1]
opposing_melt[, opposing_0_01 := NULL]
saveRDS(opposing_melt, paste0(PATH_SAVE_EVAP_TREND, "biome_dataset_rank_opposing_DCI.rds")) 
...
opposing_melt <- opposing_melt[opposing_0_01 == 1]
opposing_melt[, opposing_0_01 := NULL]
saveRDS(opposing_melt, paste0(PATH_SAVE_EVAP_TREND, "IPCC_dataset_rank_opposing_DCI.rds")) 
...
opposing_melt <- opposing_melt[opposing_0_01 == 1]
opposing_melt[, opposing_0_01 := NULL]
saveRDS(opposing_melt, paste0(PATH_SAVE_EVAP_TREND, "evaporation_quantiles_dataset_rank_opposing_DCI.rds")) 
...
opposing_melt <- opposing_melt[opposing_0_01 == 1]
opposing_melt[, opposing_0_01 := NULL]
saveRDS(opposing_melt, paste0(PATH_SAVE_EVAP_TREND, "elevation_class_dataset_rank_opposing_DCI.rds")) 
...
fill_data <- 
  data.table(dataset = rep(rep(dataset_list, each = length(KG_list)), 5), 
             ...
             variable = rep(variable_list, each = 420))
...
opposing_melt_merge <- merge(opposing_melt, fill_data, 
                             by = c('dataset', 'KG_beck', 
                                    'variable'),
                             all = T)

opposing_melt_merge[, value := value.x]
opposing_melt_merge[is.na(value.x), value := 0]

opposing_melt_merge[,value.x := NULL]
opposing_melt_merge[,value.y := NULL]

opposing_melt_merge[, rank_datasets := rank(-value), .(variable, KG_beck)]

opposing_melt_merge[variable == "area_opposing_0_01", variable := "p <= 0.01", ]
opposing_melt_merge[variable == "area_opposing_0_05", variable := "p <= 0.05", ]
opposing_melt_merge[variable == "area_opposing_0_1", variable := "p <= 0.1", ]
opposing_melt_merge[variable == "area_opposing_0_2", variable := "p <= 0.2", ]
opposing_melt_merge[variable == "area_opposing_all", variable := "p <= 1", ]


saveRDS(opposing_melt_merge, paste0(PATH_SAVE_EVAP_TREND, "KG_beck_dataset_rank_opposing_DCI.rds")) 
