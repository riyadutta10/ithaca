...
## Load data ----
evap_datasets <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "evap_datasets.rds"))
...
saveRDS(evap_datasets, paste0(PATH_SAVE_EVAP_TREND, "evap_datasets_clean.rds"))
...
saveRDS(evap_datasets_global_annual_mean, paste0(PATH_SAVE_EVAP_TREND, "global_annual_means.rds"))

### table for Zenodo ----
write.table(evap_datasets_global_annual_mean, paste0(PATH_SAVE_EVAP_TREND_TABLES, "interannual_variance_global.csv"), row.names = F, sep = ",")
...
saveRDS(evap_datasets_grid_mean, paste0(PATH_SAVE_EVAP_TREND, "evap_datasets_grid_mean.rds"))
