# Using p-value thresholds derived from bootstrap ----
...
# Allowing for 90 % consensus across significant trends ----
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_01 > 8 & N_neg_0_01 == 1, trend_0_01 := "positive"]
evap_trend_summary[ N_neg_0_01 > 8 & N_pos_0_01 == 1, trend_0_01 := "negative"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_05 > 8 & N_neg_0_05 == 1, trend_0_05 := "positive"]
evap_trend_summary[ N_neg_0_05 > 8 & N_pos_0_05 == 1, trend_0_05 := "negative"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_1 > 8 & N_neg_0_1 == 1, trend_0_1 := "positive"]
evap_trend_summary[ N_neg_0_1 > 8 & N_pos_0_1 == 1, trend_0_1 := "negative"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_2 > 8 & N_neg_0_2 == 1, trend_0_2 := "positive"]
evap_trend_summary[ N_neg_0_2 > 8 & N_pos_0_2 == 1, trend_0_2 := "negative"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_all > 8 & N_neg_all == 1, trend_all := "positive"]
evap_trend_summary[ N_neg_all > 8 & N_pos_all == 1, trend_all := "negative"]
...
## Save data ----
saveRDS(evap_trend_summary, paste0(PATH_SAVE_EVAP_TREND, "global_grid_opposing_trends_p_thresholds_bootstrap_opposers_allowed.rds"))
