...
evap_uncertainty <- evap_trend_masks[,.(trend_area = sum(area)),.(trend, evap_quant, 
                                                                  dataset_leftout)]
evap_uncertainty <- evap_uncertainty[complete.cases(evap_uncertainty)]
evap_uncertainty[, evap_area := sum(trend_area), .(evap_quant, dataset_leftout)]
...
## save data ----
saveRDS(land_cover_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "land_cover_probability_groups_dataset_leftout_bootstrap.rds"))
saveRDS(biome_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "biome_probability_groups_dataset_leftout_bootstrap.rds"))
saveRDS(elev_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "elev_probability_groups_dataset_leftout_bootstrap.rds"))
saveRDS(evap_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "evap_probability_groups_dataset_leftout_bootstrap.rds"))
saveRDS(ipcc_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "ipcc_probability_groups_dataset_leftout_bootstrap.rds"))
saveRDS(KG_3_uncertainty, paste0(PATH_SAVE_EVAP_TREND, "KG_3_probability_groups_dataset_leftout_bootstrap.rds"))
